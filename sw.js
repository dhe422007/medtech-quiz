/* sw.js v15.2.5 — cache-bust + GA除外 */
const CACHE_NAME = 'clinical-physio-v15.2.5';
...
self.addEventListener('fetch', (event) => { const url = new URL(event.request.url); if (GA_HOSTS.includes(url.hostname)) return;
